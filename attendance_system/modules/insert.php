    ...
    <nav class="navbar navbar-expand-lg navbar-dark elegant-color-dark fixed-top">
        ...
        <div class="container">
            <div class="divider-new pt-5">
                <h2 class="h2-responsive wow fadeIn">Insert</h2>
            </div>
                            ...
                            <div class="modal-dialog cascading-modal" role="document">
                                ...
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        ...
                                        <!-- Form register -->
                                        <form style="padding-left: 5%;padding-right: 5%;" action="add_prof.php" method="POST">
                                            <!-- <p class="h5 text-center mb-4">Sign up</p> -->

                                            <div class="md-form">
                                                <i class="fa fa-user prefix grey-text"></i>
                                                <input type="text" id="orangeForm-name" class="form-control" name="t_name">
                                                <label for="orangeForm-name">Your name</label>
                                            </div>
											<div class="md-form">
                                                <i class="fa fa-lock prefix grey-text"></i>
                                                <input type="password" id="orangeForm-pass" class="form-control" name="t_pwd">
                            ...
                            <div class="modal-dialog cascading-modal" role="document">
                                ...
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        ...
                                        <!-- Form register -->
                                        <form style="padding-left: 5%;padding-right: 5%;" action="add_parent.php" method="POST">
                                            <!-- <p class="h5 text-center mb-4">Sign up</p> -->

                                            <div class="md-form">
                                                <i class="fa fa-user prefix grey-text"></i>
                                                <input type="text" id="orangeForm-name" class="form-control" name="p_name">
                                                <label for="orangeForm-name">Your name</label>
                                            </div>

                                            <div class="md-form">
                                                <i class="fa fa-lock prefix grey-text"></i>
                                                <input type="password" id="orangeForm-pass" class="form-control" name="p_pwd">
                                                <label for="orangeForm-pass">Your password</label>
                                            </div>
                            ...
                            <div class="modal-dialog cascading-modal" role="document">
                                ...
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        ...
                                        <!-- Form register -->
                                        <form style="padding-left: 5%;padding-right: 5%;" action="add_student.php" method="POST">
                                            <!-- <p class="h5 text-center mb-4">Sign up</p> -->

                                            <div class="md-form">
                                                <i class="fa fa-user prefix grey-text"></i>
                                                <input type="text" id="orangeForm-name" class="form-control" name="roll_no">
                                                <label for="orangeForm-name">Roll No.</label>
                                            </div>
											
                                            <div class="md-form">
                                                <i class="fa fa-lock prefix grey-text"></i>
                                                <input type="text" id="orangeForm-pass" class="form-control" name="name">
                                                <label for="orangeForm-pass">Name</label>
                                            </div>
											
											<div class="md-form">
                                                <i class="fa fa-user prefix grey-text"></i>
                                                <input type="text" id="orangeForm-name" class="form-control" name="uname">
                                                <label for="orangeForm-name">Username</label>
                                            </div>
											
                                            <div class="md-form">
                                                <i class="fa fa-lock prefix grey-text"></i>
                                                <input type="password" id="orangeForm-pass" class="form-control" name="passwd">
                                                <label for="orangeForm-pass">Password</label>
                                            </div>
											
                                            <div class="md-form">
                                                <i class="fa fa-lock prefix grey-text"></i>
                                                <input type="text" id="orangeForm-pass" class="form-control" name="pname">
                                                <label for="orangeForm-pass">Parent Name</label>
                                            </div>
											
                                            <div class="md-form">
                                                <i class="fa fa-lock prefix grey-text"></i>
                                                <input type="text" id="orangeForm-pass" class="form-control" name="year">
                                                <label for="orangeForm-pass">Year</label>
                                            </div>
											
                                            <div class="md-form">
                                                <i class="fa fa-lock prefix grey-text"></i>
                                                <input type="text" id="orangeForm-pass" class="form-control" name="depart">
                                                <label for="orangeForm-pass">Department</label>
                                            </div>
                                ...
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        ...
                                        <!-- Form register -->
                                            ...
                                            <!-- <p class="h5 text-center mb-4">Sign up</p> -->
                                            <form style="padding-left: 5%;padding-right: 5%;" method="post" action="add_notice.php" enctype="multipart/form-data">
												<div class="md-form">
													<i class="fa fa-user prefix grey-text"></i>
													<input type="text" id="orangeForm-name" class="form-control" name="topic">
													<label for="orangeForm-name">Topic</label>
												</div>
												<div class="md-form">
													<i class="fa fa-user prefix grey-text"></i>
													<label for="orangeForm-name">File</label><br><br>
													<input type="file" id="orangeForm-name" name="fileToUpload">
													
												</div>
												
												<div class="text-center">
													<button class="btn btn-deep-orange">Upload</button>
												</div>
											</form>
