    ...
    <nav class="navbar navbar-expand-lg navbar-dark elegant-color-dark fixed-top">
        ...
        <div class="container">
            <div class="divider-new pt-5">
                <h2 class="h2-responsive wow fadeIn">Delete</h2>
            </div>
                    ...
                    <div class="col-lg-3 mb-r">
                        ...
                        <div class="card wow fadeIn">
                            ...
                            <div class="card-body">
                                ...
                                <h4 class="card-title text-center"><a href="#" data-toggle="modal" data-target="#AddProf">Professor<a></h4>
                                    <hr>
                                    <!--Text-->
                                    <p class="card-text">If you want to Remove Professor Click on this link above.</p>
                                </div>
                            ...
                            <div class="modal-dialog cascading-modal" role="document">
                                ...
                                <div class="modal-content">
                                    ...
                                    <div class="modal-header light-blue darken-3 white-text">
                                        <h4 class="title"><i class="fa fa-user"></i> Remove Professor</h4>
                                    ...
                                    <div class="modal-body">
                                        ...
                                        <!-- Form register -->
                                        <form style="padding-left: 5%;padding-right: 5%;" action="rem_prof.php" method="POST">
                                            ...
                                            <div class="text-center">
                                                <button class="btn btn-deep-orange">Remove</button>
                                            </div>
                        ...
                        <div class="col-lg-3 mb-r">
                            ...
                            <div class="card wow fadeIn" data-wow-delay="0.2s">
                                ...
                                <div class="card-body">
                                    ...
                                    <hr>
                                    <!--Text-->
                                    <p class="card-text">If you want to Remove Parent Click on this link above.</p>
                                </div>
                        ...
                        <div class="modal fade" id="AddPar" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                            <div class="modal-dialog cascading-modal" role="document">
                                ...
                                <div class="modal-content">
                                    <!--Header-->
                                    <div class="modal-header light-blue darken-3 white-text">
                                        <h4 class="title"><i class="fa fa-user"></i> Remove Parent</h4>
                                        <button type="button" class="close waves-effect waves-light" data-dismiss="modal" aria-label="Close">
                                            <span aria-hidden="true">&times;</span>
                                        </button>
                                    </div>
                                    ...
                                    <div class="modal-body">
                                        ...
                                        <!-- Form register -->
                                        <form style="padding-left: 5%;padding-right: 5%;" action="rem_parent.php" method="POST">
                                            <!-- <p class="h5 text-center mb-4">Sign up</p> -->
                        ...
                        <div class="col-lg-3 mb-r">
                            ...
                            <div class="card wow fadeIn" data-wow-delay="0.4s">
                                ...
                                <div class="card-body">
                                    ...
                                    <hr>
                                    <!--Text-->
                                    <p class="card-text">If you want to Remove Student Click on this link above.</p>
                                </div>
                        ...
                        <div class="modal fade" id="AddStud" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                            <div class="modal-dialog cascading-modal" role="document">
                                ...
                                <div class="modal-content">
                                    <!--Header-->
                                    <div class="modal-header light-blue darken-3 white-text">
                                        <h4 class="title"><i class="fa fa-user"></i> Remove Student</h4>
                                        <button type="button" class="close waves-effect waves-light" data-dismiss="modal" aria-label="Close">
                                            <span aria-hidden="true">&times;</span>
                                        </button>
                                    </div>
                                    ...
                                    <div class="modal-body">
                                        ...
                                        <!-- Form register -->
                                        <form style="padding-left: 5%;padding-right: 5%;" action="rem_student.php" method="POST">
                                            <!-- <p class="h5 text-center mb-4">Sign up</p> -->
                        ...
                        <div class="col-lg-3 mb-r">
                            ...
                            <div class="card wow fadeIn" data-wow-delay="0.6s">
                                ...
                                <div class="card-body">
                                    <!--Title-->
                                    <h4 class="card-title text-center"><a href="#" data-toggle="modal" data-target="#AddNot">Notice</a></h4>
                                    <hr>
                                    <!--Text-->
                                    <p class="card-text">If you want to Remove Notices Click on this link above.</p>
                                </div>
                        ...
                        <div class="modal fade" id="AddNot" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                            <div class="modal-dialog cascading-modal" role="document">
                                ...
                                <div class="modal-content">
                                    <!--Header-->
                                    <div class="modal-header light-blue darken-3 white-text">
                                        <h4 class="title"><i class="fa fa-user"></i> Remove Notices</h4>
                                        <button type="button" class="close waves-effect waves-light" data-dismiss="modal" aria-label="Close">
                                            <span aria-hidden="true">&times;</span>
                                        </button>
                                    </div>
                                    ...
                                    <div class="modal-body">
                                        ...
                                        <!-- Form register -->
                                        <form style="padding-left: 5%;padding-right: 5%;" action="rem_notice.php" method="POST">
                                            <!-- <p class="h5 text-center mb-4">Sign up</p> -->
